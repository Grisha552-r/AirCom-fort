      ...
      <section className="max-w-7xl mx-auto px-4 py-10">
        ...
        <div className="space-y-3 max-w-3xl">
          {[
            ...
            ['Какая гарантия на кондиционер?', 'Electrolux и LG — 3 года, Ballu и Haier — 2 года, Mitsudai и King Home — 1 год, Vicool — 7 лет. На монтажные работы — отдельная гарантия 1 год. Гарантийный ремонт выполняем бесплатно с выездом мастера.'],
