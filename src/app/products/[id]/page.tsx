...
const CATEGORY_META: Record<string, CategoryMeta> = {
  ...
  'split-vicool': {
    ...
    seoText: {
      ...
      paragraphs: [
        'Vicool — современный бренд климатической техники, выпускаемой на заводе TCL. В каталоге AirComfort представлены две линейки: VIERA (on/off и инверторные модели, хладагент R32) и PRO Light (инверторные модели с классом энергоэффективности A+++, встроенным Wi-Fi и пониженным уровнем шума от 19 дБ).',
        'Купить кондиционер Vicool в Гомеле с официальной гарантией и установкой под ключ — в AirComfort. Мощность от 7 000 до 24 000 BTU для помещений от 20 до 70 м². Монтаж от 400 р., гарантия на работы 1 год.',
      ],
    },
  },
  mobile: {
