...
const CATEGORY_META: Record<string, { title: string; description: string }> = {
  ...
  'split-vicool': {
    ...
    description: 'Кондиционеры Vicool VIERA и PRO Light в Гомеле: инверторные модели 9000–24000 BTU, хладагент R32, Wi-Fi. Монтаж от 400 р., гарантия производителя 3–5 лет.',
  },
  mobile: {
