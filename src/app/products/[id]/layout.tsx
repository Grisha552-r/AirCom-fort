...
const CATEGORY_META: Record<string, { title: string; description: string }> = {
  ...
  'split-kinghome': {
    title: 'Кондиционеры King Home в Гомеле — инверторные сплит-системы Luna Matt',
    description: 'Кондиционеры King Home в Гомеле: серия Luna Matt с Wi-Fi, инвертором, R32. Мощность 9000–24000 BTU для 25–70 м². Класс А++. Установка под ключ от 400 р., гарантия 74 месяца.',
  },
  mobile: {
