  ...
  return (
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {product.inStock && product.brand === 'Vicool' && <span className="flex items-center gap-1 bg-emerald-50 text-emerald-700 text-xs font-semibold px-3 py-1 rounded-full"><span className="w-1.5 h-1.5 rounded-full bg-emerald-500" />В наличии</span>}
      </div>
