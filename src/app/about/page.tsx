...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Стоимость стандартной установки кондиционера под ключ начинается от 400 р. Цена включает монтаж обоих блоков, прокладку трассы до 3 метров, вакуумирование и запуск. Дополнительные метры трассы — 15–20 р./м.',
  },
  {
