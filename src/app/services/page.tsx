    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <div className="max-w-3xl mx-auto px-4 py-14">
          <h2 className="text-2xl font-bold text-foreground mb-8 text-center">Вопросы об установке кондиционера</h2>
          <div className="space-y-4">
            {[
              {
                q: 'Сколько по времени занимает установка кондиционера?',
                a: 'Стандартный монтаж сплит-системы занимает 2–4 часа: замер и разметка, монтаж внутреннего и наружного блоков, прокладка трассы, вакуумирование и пусконаладочные работы. При увеличенной длине трассы или сложном маршруте (через балкон) — больше.',
              },
              {
                q: 'Нужно ли согласование для установки кондиционера в Гомеле?',
                a: (
                  <>
                    В Беларуси порядок регулируется Постановлением Совета Министров № 384: установка наружного блока на фасад многоквартирного дома обычно требует согласования с местными органами власти, на частный дом — как правило нет. Подробный порядок — в статье{' '}
                    <Link href="/articles/soglasovanie-ustanovki" className="text-crimson-700 hover:underline">«Согласование установки кондиционера»</Link>.
                  </>
                ),
              },
              {
                q: 'Что входит в стоимость установки кондиционера?',
                a: 'В стандартную стоимость от 400 р. входит: крепление внутреннего и наружного блоков, медная трасса до 3 м с изоляцией, электрокабель, сливной шланг, вакуумирование системы и пусконаладочные работы. Доплата — за трассу длиннее 3 м (50 р./м) и монтаж через балкон (50 р.).',
              },
              {
                q: 'Какая гарантия на установку кондиционера?',
                a: 'Гарантия на монтажные работы AirComfort — 1 год. Если неисправность возникла по вине монтажа, устраняем бесплатно. Отдельно действует гарантия производителя на сам кондиционер.',
              },
              {
                q: 'В каких населённых пунктах выполняете установку?',
                a: 'Устанавливаем кондиционеры в Гомеле и Гомельской области: Жлобин, Мозырь, Речица, Светлогорск, Калинковичи, Рогачёв, Петриков, Житковичи, Хойники, Лоев. Для уточнения выезда в конкретный район — звоните.',
              },
            ].map(item => (
              <div key={item.q} className="bg-white rounded-2xl border border-border p-5">
