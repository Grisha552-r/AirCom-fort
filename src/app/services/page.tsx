        ...
        <div className="max-w-3xl mx-auto px-4 py-14">
          ...
          <div className="space-y-4">
            {[
              ...
              {
                q: 'Как заказать установку кондиционера на этой странице?',
                a: 'Выберите услугу и параметры в калькуляторе выше — он сразу покажет итоговую цену. Добавьте в корзину или позвоните по телефону +375 29 105-06-94, мы согласуем удобное время выезда мастера.',
              },
              {
                q: 'Можно ли заказать установку кондиционера в день обращения?',
                a: 'Да, при заявке в рабочее время (с 9:00 до 18:00, пн–сб) часто выезжаем в день обращения, в остальных случаях — на следующий день.',
              },
            ].map(item => (
