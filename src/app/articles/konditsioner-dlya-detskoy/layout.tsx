...
export const metadata: Metadata = {
  title: 'Кондиционер в детскую комнату — безопасный выбор и установка в Гомеле',
  description: 'Какой кондиционер выбрать для детской: безопасный уровень шума, фильтрация воздуха, режим без сквозняков. ТОП моделей для детской в Гомеле с установкой.',
  keywords: [
    'кондиционер для детской',
    'кондиционер детская комната',
    'кондиционер для ребёнка',
    'безопасный кондиционер для детей',
    'кондиционер детская Гомель',
    'тихий кондиционер детская',
    'кондиционер с очисткой воздуха детская',
  ],
