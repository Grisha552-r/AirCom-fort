...
export const metadata: Metadata = {
  title: 'Сколько стоит установка кондиционера в Гомеле в 2025 году — цены на монтаж',
  description: 'Актуальные цены на установку кондиционера в Гомеле в 2025 году. Монтаж от 400 р. Что входит в стоимость, скрытые доплаты, сравнение вариантов.',
  keywords: ['установка кондиционера цена Гомель', 'сколько стоит установка кондиционера', 'монтаж кондиционера цена', 'стоимость установки кондиционера Гомель 2025'],
  alternates: { canonical: 'https://aircom-fort.by/articles/tsena-ustanovki-konditsionera' },
  openGraph: {
    title: 'Сколько стоит установка кондиционера в Гомеле — цены 2025',
