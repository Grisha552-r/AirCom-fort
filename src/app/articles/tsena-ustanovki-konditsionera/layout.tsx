...
export const metadata: Metadata = {
  title: 'Цена установки кондиционера в Гомеле — монтаж 2026',
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Стандартный монтаж кондиционера в AirComfort: до 30 м² — 400 р., до 50 м² — 500 р., до 70 м² — 550 р. В стоимость включена трасса 3 м, медные трубки, кабель и всё крепление.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'В базовую цену монтажа входит: прокладка трассы длиной 3 м, медные трубки, электрокабель, крепление внутреннего и наружного блоков, вакуумирование системы, пусконаладочные работы и проверка. Доплата за каждый доп. метр трассы — 50 р.',
      },
    },
    {
      '@type': 'Question',
