...
export default function RemontPage() {
  const jsonLd = {
    ...
    '@type': 'Article',
    headline: 'Ремонт кондиционера в Гомеле — диагностика бесплатно, цены 2026',
    ...
    description: 'Ремонт кондиционеров в Гомеле. Не охлаждает, течёт, не включается. Диагностика бесплатно.',
