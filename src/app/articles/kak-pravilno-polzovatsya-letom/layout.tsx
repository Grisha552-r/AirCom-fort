...
export const metadata: Metadata = {
  ...
  description: '7 правил использования кондиционера летом: оптимальная температура, правильные режимы, почему болит горло. Не простудитесь и сэкономьте на электричестве.',
