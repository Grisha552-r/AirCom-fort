...
export const metadata: Metadata = {
  ...
  description: 'Какой кондиционер выбрать для спальни: уровень шума до 26 дБ, режим ночной работы, инвертор. ТОП бесшумных моделей 2026: Electrolux, Ballu, Haier в наличии в Гомеле.',
  keywords: [
