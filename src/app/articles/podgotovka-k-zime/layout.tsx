...
export const metadata: Metadata = {
  ...
  description: 'Пошаговая инструкция: когда выключать кондиционер на зиму, нужна ли консервация, что проверить осенью. Советы мастеров AirComfort для Беларуси.',
