...
export const metadata: Metadata = {
  ...
  description: 'Инверторный кондиционер в Гомеле от 1 290 р. Electrolux, Ballu, Haier, LG — инвертор с установкой под ключ. Экономия до 40% электроэнергии. Монтаж в день заказа.',
  keywords: [
