...
const faqLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Базовая чистка кондиционера в Гомеле — от 60 р. Полное ТО с промывкой теплообменника — от 80 р. Заправка фреоном R410A — от 60 р. Диагностика — бесплатно при проведении обслуживания.',
      },
    },
  ],
};
...
const SERVICES = [
  ...
  { name: 'Чистка теплообменника', price: 'от 60 р.', desc: 'Промывка внутреннего блока спецраствором. Восстанавливает производительность.' },
