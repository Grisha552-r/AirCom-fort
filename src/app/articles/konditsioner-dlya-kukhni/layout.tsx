...
export const metadata: Metadata = {
  ...
  description: 'Как выбрать кондиционер для кухни: мощность с учётом плиты, требования к монтажу, лучшие модели. Особенности установки кондиционера на кухне в Гомеле.',
  keywords: [
