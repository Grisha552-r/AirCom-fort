...
export const metadata: Metadata = {
  ...
  description: 'Купить сплит-систему в Гомеле с установкой от 1 290 р. Все ведущие бренды в наличии. Монтаж под ключ в день заказа. Гарантия 1 год на монтаж, до 3 лет на оборудование.',
  keywords: [
