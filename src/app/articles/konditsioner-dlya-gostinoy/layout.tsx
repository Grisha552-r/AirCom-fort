...
export const metadata: Metadata = {
  title: 'Кондиционер для гостиной — какой выбрать в 2026',
  description: 'Кондиционер для гостиной в Гомеле: мощность по площади, рейтинг брендов, цены 2026. Монтаж под ключ от 1 290 р. — выезд мастера в день заказа.',
