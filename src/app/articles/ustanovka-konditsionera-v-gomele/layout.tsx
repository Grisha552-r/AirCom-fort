...
export const metadata: Metadata = {
  title: 'Установка кондиционера в Гомеле — монтаж от 400 р. за 1 день',
  description: 'Монтаж кондиционера в Гомеле от 400 р. под ключ: трасса, кронштейны, вакуумирование включены. Выезд мастера в день заказа. Кондиционер + установка от 1 290 р. Гарантия 1 год.',
  keywords: [
