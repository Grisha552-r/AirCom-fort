...
export const metadata: Metadata = {
  ...
  description: 'Как выбрать кондиционер по площади: формула расчёта мощности, инвертор или On/Off, рейтинг брендов 2026. Не переплатите — советы экспертов AirComfort Гомель.',
