...
export const metadata: Metadata = {
  ...
  description: 'Как правильно выбрать кондиционер для комнаты 20, 25 или 30 кв м. Расчёт мощности, инвертор или on/off, лучшие модели 2026. Советы мастеров AirComfort.',
