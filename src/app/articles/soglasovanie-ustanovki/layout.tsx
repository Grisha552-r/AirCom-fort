...
export const metadata: Metadata = {
  ...
  description: 'Нужно ли разрешение на кондиционер в Беларуси? Когда требуется согласование, какие документы и какой штраф за самовольный монтаж на фасад дома.',
