        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 text-sm text-muted-foreground leading-relaxed">
            <div className="space-y-4">
              <h3 className="text-lg font-bold text-foreground">О нас</h3>
              <p>
                AirComfort работает в Гомеле с 2019 года. Официальный дилер Electrolux, Ballu,
                Haier, LG и Mitsudai — всё оборудование поставляется с гарантией производителя.
                Более 500 выполненных монтажей в Гомеле и области.
              </p>
              <p>
                Монтаж под ключ — от 400 р.: разметка, бурение, прокладка трассы, вакуумирование
                и запуск. Все расходники включены. Приезжаем в день заказа, работаем пн–сб с 9:00.
              </p>
              <p>
                Мощность по площади: до 20 м² — <strong className="text-foreground">9 000 BTU</strong>,
                до 35 м² — <strong className="text-foreground">12 000 BTU</strong>,
                до 50 м² — <strong className="text-foreground">18 000 BTU</strong>.
              </p>
            </div>
            <div className="space-y-4">
              <h3 className="text-lg font-bold text-foreground">Инвертор или On/Off — что выгоднее</h3>
              <p>
                Инверторная сплит-система плавно меняет мощность вместо постоянных включений/выключений.
                Результат: до 40% экономии электроэнергии, тихая работа и точная температура.
                Разница в цене окупается за 2 сезона при ежедневном использовании.
              </p>
              <p>
                Большинство современных моделей работают и на обогрев при −15 °C — в 3 раза
                экономичнее электрообогревателя. Для арендного жилья или дачи, где сверлить
                нельзя, подойдёт мобильный вариант без монтажа.
              </p>
